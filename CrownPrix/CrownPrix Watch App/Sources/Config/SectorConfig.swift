...
enum SectorConfig {
    ...
    static func layout(for trackId: String) -> TrackLayout {
        ...
        case "monaco":            return TrackLayout(startOffset: 0.00, sector1End: 0.277, sector2End: 0.644)
        ...
        case "baku":              return TrackLayout(startOffset: 0.00, sector1End: 0.233, sector2End: 0.630)
