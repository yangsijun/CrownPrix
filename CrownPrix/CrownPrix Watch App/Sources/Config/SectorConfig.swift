...
enum SectorConfig {
    ...
    static func layout(for trackId: String) -> TrackLayout {
        ...
        case "miami":             return TrackLayout(startOffset: 0.04, sector1End: 0.324, sector2End: 0.659)
        ...
        case "madring":           return TrackLayout(startOffset: 0.16, sector1End: 0.333, sector2End: 0.667)
